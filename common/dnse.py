"""Giá cổ phiếu từ DNSE/Entrade — miễn phí, không token. App này giữ giá theo NGHÌN ĐỒNG
như bảng giá CTCK — mẫu hình nến chỉ dùng tỷ lệ nên đơn vị không ảnh hưởng gì.
...
# (chỉ hiển thị giá như bảng giá, không định giá danh mục nên không cần VND).
PRICE_UNIT = 1.0
